...
impl ReaderSession {
    ...
    /// Adjusts retained layout memory without invalidating the current page.
    /// Mobile hosts use this in response to platform memory-pressure events.
    pub fn set_segment_cache_capacity(&mut self, capacity: usize) {
    ...
    pub fn segment_cache_capacity(&self) -> usize {
        self.cache_capacity
    }
